...
import os # 用于读取图片, operating system
...
# <h4> stands for heading 4
# <p> stands for paragraph
# <br> stands for line break
# <a href="mailto:sarah.johnson@example.com"> stands for email link 
...
# you can change the size of the image by changing the width parameter
...
# About Me is the key for the About Me section
